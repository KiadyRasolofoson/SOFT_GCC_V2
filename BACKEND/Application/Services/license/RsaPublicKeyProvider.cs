...
{
    /// <summary>
    /// Fournisseur singleton de la clé publique RSA.
    /// La clé publique est embarquée en tant que constante string dans le code
    /// (compilée dans le binaire) et l'instance RSA est créée une seule fois au démarrage.
    /// </summary>
    public class RsaPublicKeyProvider : IDisposable
    {
        // =========================================================================
