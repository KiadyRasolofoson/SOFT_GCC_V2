...
function ModalAddOtherSkill ({ showOtherSkill, handleCloseOtherSkill, idEmployee, fetchData, error, dataEmployeeDescription }) {
  ...
  const validateForm = () => {
    ...
    return (
        <Modal
          isOpen={showOtherSkill}
          onRequestClose={handleCloseOtherSkill}
          contentLabel="Ajouter d'autre formation"
          className="modal-content"
          overlayClassName="modal-overlay"
        >
          <div className="modal-header">
              <h2>Ajouter d'autre formation</h2>
              <button onClick={handleCloseOtherSkill} className="close-button">&times;</button>
          </div>
          ...
          <div className="modal-footer">
              <button onClick={handleCloseOtherSkill} className="button button-secondary">Fermer</button>
