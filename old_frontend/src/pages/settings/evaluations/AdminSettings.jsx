...
const AdminSettings = () => {
    ...
    useEffect(() => {
        ...
        if (!canAccess) {
            ...
            navigate('/soft-gcc/evaluations/parametres');
        } else {
            fetchEvaluations();
        }
    ...
    const fetchEvaluations = async () => {
        ...
        try {
            ...
            const response = await axios.get(urlApi('/evaluation/templates'), {
    ...
    const fetchEvaluationQuestions = async (evaluationTypeId) => {
        ...
        try {
            ...
            const response = await axios.get(urlApi(`/evaluation/${evaluationTypeId}/questions`), {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    // Réinitialiser les temps à la valeur par défaut
    ...
    const saveTimeConfigurations = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                urlApi('/evaluation/questions/update-time'),
                questionsWithTime,
                { headers: { Authorization: `Bearer ${token}` } }
            );
